...
@section('titulo','Editar Produtos | Construmob')
    ...
    <form class="" action="{{route('admin.produtos.atualizar',$registro->id)}}" method="post" enctype="multipart/form-data" id="form">
      ...
      <div class="row">
        <div class="col s12 center-align">
          <button title="Atualizar" class="btn light-blue darken-4 text-center" type="button" id="atualizar_produto">Atualizar</button>
        </div>
      </div>
    </form>
  </div>
